...
import { $ as $fetch, w as withQuery, l as hasProtocol, m as isScriptProtocol, n as joinURL, o as sanitizeStatusCode, p as createHooks, h as createError$1, q as isEqual, t as toRouteMatcher, r as createRouter, v as defu, x as stringifyParsedURL, y as stringifyQuery, z as parseQuery } from '../runtime.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h2>Bonjour Le Monde. C&#39;est un monde meilleur.</h2></div>`);
}
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C-abyQTB.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Cy53bwlz.mjs').then((r) => r.default || r));
